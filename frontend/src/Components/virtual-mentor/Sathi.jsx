  ...
  return (
    <div className="base-container py-[5vh] flex flex-col justify-center items-center ">
      ...
      <div className="flex-grow flex flex-col items-center justify-center my-10">
        <div
          className="border p-4 rounded-lg shadow-lg w-[900px] h-full"
          ref={messagesEndRef}
        >
          <div
            className="border p-2 h-[50vh] overflow-y-auto "
          ...
          <div className="mt-4 flex ">
            <input
              type="text"
              className="flex-grow border rounded p-2 mr-2 outline-none"
